<?php
// templates/partials/modal_absen.php
?>
      ...
      <div class="modal-body">
        <form id="formAbsen" onsubmit="kirimAbsensi(event)">
            ...
            <div class="row mb-3">
              <div class="mb-3">
                  <div class="d-flex justify-content-between align-items-center mb-1">
                      ...
                      <button type="button" class="btn btn-outline-primary btn-sm" id="btnDapatkanLokasi">
                          <i class="bi bi-geo-alt-fill"></i> Dapatkan Lokasi
                      </button>
                  </div>
                  <p id="alamatTerdeteksi" class="form-control-plaintext text-muted"><i>Klik "Dapatkan Lokasi" untuk memulai...</i></p>
                  </div>
                <div class="col-md-6">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" id="btnTakePhoto" disabled>Ambil Foto</button>
