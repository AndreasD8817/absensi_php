                        ...
                        <tbody>
                            ...
                            <?php else: ?>
                                ...
                                foreach ($dates_on_page as $date): 
                                    ...
                                    // ... (LOGIKA PHP UNTUK MENAMPILKAN DATA TABEL TETAP SAMA, TIDAK PERLU DIUBAH) ...
                                    $jam_kerja_mulai = '';
                                    $jam_kerja_selesai = '';
                                    ...
                                    $dinas_luar = false; $catatan_dinas_luar = '';
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php
                                        if ($dinas_luar) { echo htmlspecialchars($catatan_dinas_luar); } 
                                        else { echo htmlspecialchars($catatan_masuk . ($catatan_pulang ? ' - ' . $catatan_pulang : '')); }
                                        ?>
                                    </td>
                                </tr>
                                <?php endforeach; ?>
...
<?php
// Memanggil modal tetap diperlukan
require_once 'partials/modal_absen.php'; // <-- TAMBAHKAN BARIS INI
