                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($laporan['masuk'] && $laporan['masuk']['foto']): ?>
                                    <button class="btn btn-info btn-sm" data-bs-toggle="modal" data-bs-target="#proofModal" data-nama="<?php echo htmlspecialchars($laporan['nama_lengkap']); ?>" data-tipe="Masuk" data-jam="<?php echo $absen_masuk->format('H:i:s'); ?>" data-catatan="<?php echo htmlspecialchars($laporan['masuk']['catatan']); ?>" data-foto="../uploads/foto_absen/<?php echo $laporan['masuk']['foto']; ?>" data-lat="<?php echo $laporan['masuk']['latitude']; ?>" data-lon="<?php echo $laporan['masuk']['longitude']; ?>"><i class="bi bi-camera-fill"></i></button>
                                <?php endif; ?>
                                <?php if ($laporan['pulang'] && $laporan['pulang']['foto']): ?>
                                    <button class="btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#proofModal" data-nama="<?php echo htmlspecialchars($laporan['nama_lengkap']); ?>" data-tipe="Pulang" data-jam="<?php echo $absen_pulang->format('H:i:s'); ?>" data-catatan="<?php echo htmlspecialchars($laporan['pulang']['catatan']); ?>" data-foto="../uploads/foto_absen/<?php echo $laporan['pulang']['foto']; ?>" data-lat="<?php echo $laporan['pulang']['latitude']; ?>" data-lon="<?php echo $laporan['pulang']['longitude']; ?>"><i class="bi bi-camera-fill"></i></button>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <?php endforeach; ?>
