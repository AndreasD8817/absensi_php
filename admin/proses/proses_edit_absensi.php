...
try {
    ...
    // 1. Ambil id_absensi DAN nama filenya
    ...
    if ($dl_row = mysqli_fetch_assoc($result_dl)) {
        ...
        // 3. Hapus referensi dari tabel_dinas_luar
    ...
    // 4. Hapus data absensi 'Dinas Luar' itu sendiri
    ...
    // ================== AKHIR PERBAIKAN ==================
        ...
        // --- Proses Absen Pulang --- (Logika sama dengan absen masuk)
    ...
    if ($status_absensi === 'dinas_luar') {
        // Hapus dulu data Masuk & Pulang jika ada, untuk membersihkan.
        ...
        if ($dl_data) { // Ada -> UPDATE
            ...
            // Insert ke tabel_absensi dulu
            $waktu_dl = $tanggal . ' 08:00:00'; // Default jam DL
