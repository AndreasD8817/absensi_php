...
<div class="row text-center justify-content-center">
    ...
    <div class="col-md-4 mb-3">
        <a href="/admin/kelola-libur" class="card-menu">
    ...
    <div class="col-md-4 mb-3">
        <a href="/admin/laporan-absensi" class="card-menu">
            <div class="card shadow-sm">
                <div class="card-body">
    ...
    <div class="col-md-4 mb-3">
        <a href="/admin/impor-absensi" class="card-menu">
            <div class="card shadow-sm">
                <div class="card-body">
    ...
    <div class="col-md-4 mb-3">
        <a href="/admin/impor-pegawai" class="card-menu">
            <div class="card shadow-sm">
                <div class="card-body">
    ...
    <div class="col-md-4 mb-3">
        <a href="/admin/manajemen-user" class="card-menu">
            <div class="card shadow-sm">
                <div class="card-body">
    ...
    <div class="col-md-4 mb-3">
        <a href="/admin/pengaturan" class="card-menu">
            <div class="card shadow-sm">
                <div class="card-body">
